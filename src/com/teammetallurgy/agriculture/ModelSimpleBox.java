...
public class ModelSimpleBox {
    ...
    public ModelSimpleBox(final int textureWidth, final int textureHeight, final int textureX, final int textureZ, float posX, float posY, float posZ, final int width, final int height, final int width2, final int par10, final Icon liquidIcon)
    {
        icon = liquidIcon;
        posX1 = posX;
        posY1 = posY;
