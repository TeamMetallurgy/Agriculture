...
public class AgricultureBlocks
{
    ...
    public static void init()
    {
        ...
        vanilla = new BlockSpice(ConfigHandler.getBlockId("Vanilla", def++)).setDrop(AgricultureItems.vanilla.getItemStack()).setHardness(1.0f).setUnlocalizedName("agriculture:vanilla")
                .func_111022_d("agriculture:vanilla").setCreativeTab(Agriculture.tab);
        peanut = new BlockPeanut(ConfigHandler.getBlockId("Peanut", def++)).setHardness(0.1f).setUnlocalizedName("agriculture:peanut").func_111022_d("agriculture:peanut").setCreativeTab(Agriculture.tab);
