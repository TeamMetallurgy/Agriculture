...
//        LanguageRegistry.addName(AgricultureBlocks.frier, "Frier");
    ...
    public static void init()
    {
        ...
        int def = 3000;
//        AgricultureBlocks.oven = new BlockOven(ConfigHandler.getBlock("Oven", def++), Material.wood).setUnlocalizedName("agriculture:oven").setCreativeTab(Agriculture.tab);
//        AgricultureBlocks.counter = new BlockCounter(ConfigHandler.getBlock("Counter", def++), Material.wood).setUnlocalizedName("agriculture:counter").setCreativeTab(Agriculture.tab);
        AgricultureBlocks.processor = new BlockProcessor(ConfigHandler.getBlock("Processor", def++)).setUnlocalizedName("agriculture:processor").setCreativeTab(Agriculture.tab);
        AgricultureBlocks.salt = new BlockSalt(ConfigHandler.getBlock("Salt", def++), Material.rock).setHardness(1.5F).setUnlocalizedName("agriculture:salt").setTextureName("agriculture:Salt").setCreativeTab(Agriculture.tab);
        AgricultureBlocks.cinnamon = new BlockSpice(ConfigHandler.getBlock("Cinnamon", def++), AgricultureItems.cinnamon.getItemStack()).setHardness(1.0f).setUnlocalizedName("agriculture:cinnamon").setTextureName("agriculture:cinnamon").setCreativeTab(Agriculture.tab);

//        AgricultureBlocks.brewer = new BlockBrewer(ConfigHandler.getBlock("Brewer", def++), Material.wood).setUnlocalizedName("agriculture:brewer").setCreativeTab(Agriculture.tab);
//        AgricultureBlocks.icebox = new BlockIcebox(ConfigHandler.getBlock("Icebox", def++), Material.wood).setUnlocalizedName("agriculture:icebox").setCreativeTab(Agriculture.tab);
//        AgricultureBlocks.frier = new BlockFrier(ConfigHandler.getBlock("Frier", def++), Material.wood).setUnlocalizedName("agriculture:frier").setCreativeTab(Agriculture.tab);

        AgricultureBlocks.vanilla = new BlockSpice(ConfigHandler.getBlock("Vanilla", def++), AgricultureItems.vanilla.getItemStack()).setHardness(1.0f).setUnlocalizedName("agriculture:vanilla").setTextureName("agriculture:vanilla").setCreativeTab(Agriculture.tab);
        AgricultureBlocks.peanut = new BlockPeanut(ConfigHandler.getBlock("Peanut", def++)).setHardness(0.1f).setUnlocalizedName("agriculture:peanut").setTextureName("agriculture:peanut").setCreativeTab(Agriculture.tab);
        AgricultureBlocks.strawberry = new BlockStrawberry(ConfigHandler.getBlock("Strawberry", def++)).setHardness(0.1f).setUnlocalizedName("agriculture:strawberry").setTextureName("agriculture:strawberry").setCreativeTab(Agriculture.tab);
