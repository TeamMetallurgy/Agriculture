...
public class AgricultureItems {
    ...
    public static void addRecipes()
    {
        ...
        GameRegistry.addRecipe(AgricultureItems.clayBowl.getItemStack(12), "X X", " X ", 'X', Items.clay_ball);
        GameRegistry.addRecipe(AgricultureItems.clayPlate.getItemStack(12), "XXX", 'X', Items.clay_ball);
        GameRegistry.addRecipe(AgricultureItems.clayCup.getItemStack(12), "X", "X", 'X', Items.clay_ball);
        GameRegistry.addRecipe(AgricultureItems.ovenRack.getItemStack(16), "XXX", "XXX", "XXX", 'X', Blocks.iron_bars);

        GameRegistry.addShapelessRecipe(AgricultureItems.water.getItemStack(), AgricultureItems.ceramicCup.getItemStack(), Items.water_bucket);
        GameRegistry.addShapelessRecipe(AgricultureItems.milk.getItemStack(), AgricultureItems.ceramicCup.getItemStack(), Items.milk_bucket);

        GameRegistry.addShapelessRecipe(AgricultureItems.candiedApple.getItemStack(), Items.apple, Items.stick);

        FurnaceRecipes.smelting().func_151394_a(AgricultureItems.clayBowl.getItemStack(), AgricultureItems.ceramicBowl.getItemStack(), 0.1f);
        FurnaceRecipes.smelting().func_151394_a(AgricultureItems.clayPlate.getItemStack(), AgricultureItems.ceramicPlate.getItemStack(), 0.1f);
        FurnaceRecipes.smelting().func_151394_a(AgricultureItems.clayCup.getItemStack(), AgricultureItems.ceramicCup.getItemStack(), 0.1f);
    ...
    {
        if (item != null && !(item instanceof SuperItem)) { throw new IllegalArgumentException("Slot " + id + " is already occupied by " + item); }
    }
    ...
    {
        LogHandler.log("Tweaked " + stack.getUnlocalizedName() + " recipe.");
    }
    ...
    public static void tweakRecipeIguana()
    {
        ...
        GameRegistry.addRecipe(AgricultureItems.clayBowl.getItemStack(20), "X X", "XXX", 'X', Items.clay_ball);
    }
    ...
    public static void tweakRecipeOvenRack()
    {
        ...
        tweakRecipe(itemStack);
        GameRegistry.addRecipe(AgricultureItems.ovenRack.getItemStack(), "sss", "sfs", "sss", 's', Items.stick, 'f', Blocks.iron_bars);
    }
}
