...
public class AgricultureBlocks {
    ...
    public static void init()
    {
        ...
        int def = 3000;
        AgricultureBlocks.oven = new BlockOven(ConfigHandler.getBlock("Oven", def++), Material.wood).setBlockName("agriculture:oven").setCreativeTab(Agriculture.tab);
        AgricultureBlocks.counter = new BlockCounter(ConfigHandler.getBlock("Counter", def++), Material.wood).setBlockName("agriculture:counter").setCreativeTab(Agriculture.tab);
        AgricultureBlocks.processor = new BlockProcessor(ConfigHandler.getBlock("Processor", def++), Material.wood).setBlockName("agriculture:processor").setCreativeTab(Agriculture.tab);
        AgricultureBlocks.salt = new BlockSalt(ConfigHandler.getBlock("Salt", def++), Material.rock).setHardness(1.5F).setBlockName("agriculture:salt").setBlockTextureName("agriculture:Salt").setCreativeTab(Agriculture.tab);
        AgricultureBlocks.cinnamon = new BlockSpice(ConfigHandler.getBlock("Cinnamon", def++), AgricultureItems.cinnamon.getItemStack()).setHardness(1.0f).setBlockName("agriculture:cinnamon").setBlockTextureName("agriculture:cinnamon").setCreativeTab(Agriculture.tab);

        AgricultureBlocks.brewer = new BlockBrewer(ConfigHandler.getBlock("Brewer", def++), Material.wood).setBlockName("agriculture:brewer").setCreativeTab(Agriculture.tab);
        AgricultureBlocks.icebox = new BlockIcebox(ConfigHandler.getBlock("Icebox", def++), Material.wood).setBlockName("agriculture:icebox").setCreativeTab(Agriculture.tab);
        AgricultureBlocks.frier = new BlockFrier(ConfigHandler.getBlock("Frier", def++), Material.wood).setBlockName("agriculture:frier").setCreativeTab(Agriculture.tab);

        AgricultureBlocks.vanilla = new BlockSpice(ConfigHandler.getBlock("Vanilla", def++), AgricultureItems.vanilla.getItemStack()).setHardness(1.0f).setBlockName("agriculture:vanilla").setBlockTextureName("agriculture:vanilla").setCreativeTab(Agriculture.tab);
        AgricultureBlocks.peanut = new BlockPeanut(ConfigHandler.getBlock("Peanut", def++)).setHardness(0.1f).setBlockName("agriculture:peanut").setBlockTextureName("agriculture:peanut").setCreativeTab(Agriculture.tab);
        AgricultureBlocks.strawberry = new BlockStrawberry(ConfigHandler.getBlock("Strawberry", def++)).setHardness(0.1f).setBlockName("agriculture:strawberry").setBlockTextureName("agriculture:strawberry").setCreativeTab(Agriculture.tab);
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(AgricultureBlocks.oven), "WWW", "BFB", "BBB", 'W', "plankWood", 'F', Blocks.furnace, 'B', Items.brick));
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(AgricultureBlocks.brewer), "BBB", "BGB", "BIB", 'G', Blocks.glass, 'I', Items.iron_ingot, 'B', Items.brick));
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(AgricultureBlocks.counter), "WWW", "BCB", "BBB", 'W', "plankWood", 'C', Blocks.chest, 'B', Items.brick));
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(AgricultureBlocks.processor), "WIW", "BFB", "BBB", 'W', "plankWood", 'I', Items.iron_ingot, 'F', Blocks.furnace, 'B', Items.brick));
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(AgricultureBlocks.icebox), "BIB", "BBB", "BIB", 'I', Items.iron_ingot, 'B', Items.brick));
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(AgricultureBlocks.frier), "BIB", "BGB", "BIB", 'I', Items.iron_ingot, 'G', Blocks.glass, 'B', Items.brick));
