...
public class ContainerFrier extends Container {
    ...
    public ContainerFrier(final InventoryPlayer invPlayer, final TileEntityFrier cabinet)
    {
        this.cabinet = cabinet;
        cabinet.getInventory().openInventory();
    ...
    public void onContainerClosed(final EntityPlayer entityplayer)
    {
        ...
        cabinet.getInventory().closeInventory();
    }
    ...
    public ItemStack transferStackInSlot(final EntityPlayer par1EntityPlayer, final int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            if (par2 < 10)
            {
                if (!mergeItemStack(itemstack1, 10, inventorySlots.size(), true)) { return null; }
            }
            else if (!mergeItemStack2(itemstack1, 0, 10, false)) { return null; }
